...
class ArduinoBallLossBridge(Node):
    def __init__(self, args):
        ...
        self.reset_client = self.create_client(DynamixelReset, args.reset_service)
...
def main():
    ...
    parser.add_argument("--topic", default="/cyberrunner_state_estimation/estimate")
    ...
    parser.add_argument("--reset_service", default="cyberrunner_dynamixel/reset")
