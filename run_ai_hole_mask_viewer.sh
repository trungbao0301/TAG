...
PACKAGE_PREFIX="$PROJECT_ROOT/install/tag_state_estimation"
PYTHON_PACKAGE="$PROJECT_ROOT/build/tag_state_estimation"
VIEWER="$PACKAGE_PREFIX/lib/tag_state_estimation/ai_hole_viewer"
