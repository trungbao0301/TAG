#!/usr/bin/env python3
"""Convert TAG map and path DXFs into training and live-view assets.
...
DEFAULT_MAP = ROOT / "tag_dreamer" / "data" / "map.DXF"
DEFAULT_PATH = ROOT / "tag_dreamer" / "data" / "path.DXF"
MAIN_LAYOUT = (
    ROOT
    / "tag_dreamer"
    / "tag_dreamer"
...
MAIN_PICKLE = ROOT / "tag_dreamer" / "data" / "path_custom.pkl"
THOMAS_PICKLE = ROOT / "tag_dreamer" / "data" / "path_custom.pkl"
ESTIMATOR_LAYOUT = (
    ROOT
...
def _format_layout(layout, map_name, path_name):
    ...
    return (
        f"# Generated from {map_name} and {path_name} by tools/dxf_to_tag.py\n"
        "# Do not hand-edit; rerun the converter so training and live view stay aligned.\n"
        f"tag_dxf_layout = {payload}\n"
    )
...
def main():
    ...
    parser.add_argument(
        "--preview",
        type=Path,
        default=ROOT / "tag_dreamer" / "data" / "map_preview.png",
    )
